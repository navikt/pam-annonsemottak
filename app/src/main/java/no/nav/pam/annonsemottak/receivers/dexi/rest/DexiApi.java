package no.nav.pam.annonsemottak.receivers.dexi.rest;

import no.nav.pam.annonsemottak.receivers.common.rest.payloads.ResultsOnSave;
import no.nav.pam.annonsemottak.receivers.dexi.DexiConfiguration;
import no.nav.pam.annonsemottak.receivers.dexi.DexiException;
import no.nav.pam.annonsemottak.receivers.dexi.DexiService;
